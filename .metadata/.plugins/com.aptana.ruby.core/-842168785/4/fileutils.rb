module FileUtils
  ...
  LOW_METHODS = [:chdir, :getwd, :pwd, :private_module_function, :cd, :identical?, :uptodate?, :collect_method, :remove_file, :have_option?, :copy_file, :commands, :copy_entry, :copy_stream, :options, :remove_entry_secure, :remove_entry, :remove_dir, :compare_file, :options_of, :compare_stream, :cmp]
  LowMethods = FileUtils::LowMethods
  METHODS = [:chdir, :getwd, :pwd, :mkdir, :rmdir, :mkdir_p, :cd, :identical?, :uptodate?, :install, :chmod, :chown, :mkpath, :makedirs, :link, :symlink, :remove, :ln, :remove_file, :ln_s, :cp, :copy_file, :copy, :cp_r, :copy_entry, :ln_sf, :copy_stream, :mv, :remove_entry_secure, :remove_entry, :move, :rm, :rm_f, :safe_unlink, :rm_r, :rm_rf, :rmtree, :remove_dir, :compare_file, :compare_stream, :cmp, :chmod_R, :chown_R, :touch]
