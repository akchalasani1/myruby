module Gem
  ...
  LOADED_SPECS_MUTEX = #<Thread::Mutex:0x00007f98aa840838>
  ...
  RUBYGEMS_DIR = "/System/Library/Frameworks/Ruby.framework/Versions/2.3/usr/lib/ruby/2.3.0"
  ...
  RubyGemsPackageVersion = "2.5.2.3"
  RubyGemsVersion = "2.5.2.3"
