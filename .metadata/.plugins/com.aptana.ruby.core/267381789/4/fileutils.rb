module FileUtils
  ...
  LOW_METHODS = [:chdir, :getwd, :pwd, :private_module_function, :cd, :uptodate?, :have_option?, :commands, :options_of, :collect_method, :identical?, :remove_file, :copy_file, :copy_entry, :remove_entry_secure, :remove_entry, :copy_stream, :options, :remove_dir, :compare_file, :compare_stream, :cmp]
  LowMethods = FileUtils::LowMethods
  METHODS = [:chdir, :getwd, :pwd, :mkdir, :rmdir, :cd, :mkdir_p, :uptodate?, :mkpath, :makedirs, :ln, :identical?, :remove_file, :ln_s, :ln_sf, :install, :cp, :chmod, :chown, :copy, :copy_file, :link, :symlink, :copy_entry, :remove, :cp_r, :mv, :remove_entry_secure, :remove_entry, :move, :rm, :rm_f, :copy_stream, :safe_unlink, :rm_r, :rm_rf, :rmtree, :remove_dir, :compare_file, :compare_stream, :cmp, :chmod_R, :chown_R, :touch]
