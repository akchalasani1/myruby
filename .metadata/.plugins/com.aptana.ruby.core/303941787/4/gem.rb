module Gem
  ...
  LOADED_SPECS_MUTEX = #<Thread::Mutex:0x00007f84f8015cc8>
  Licenses = Gem::Licenses
  List = Gem::List
  LoadError = Gem::LoadError
  MARSHAL_SPEC_DIR = "quick/Marshal.4.8/"
  MissingSpecError = Gem::MissingSpecError
  MissingSpecVersionError = Gem::MissingSpecVersionError
  ...
  READ_BINARY_ERRORS = [Errno::EACCES, Errno::ENOTSUP]
  ...
  RUBYGEMS_DIR = "/Users/anil/.rbenv/versions/2.4.2/lib/ruby/2.4.0"
  ...
  WRITE_BINARY_ERRORS = [Errno::ENOTSUP]

  def self.activate_bin_path(arg0, arg1, arg2)
  end
  ...
  def self.write_binary(arg0, arg1)
  end
