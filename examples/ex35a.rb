def gold_room
  ...
  if how_much < 50
    ...
    puts "WOW, that's a lot of gold, are you sure you can carry it all?"
...
def bear_room
  ...
  while true
    ...
    if choice == "take honey"
      ...
      puts "The bear has moved from the door. You can go through it now. * open door or taunt bear *"
      bear_moved = true
    elsif choice == "taunt bear" && bear_moved
